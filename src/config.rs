...
pub mod svrs_production {
    ...
    pub const URLS: ServiceUrls = ServiceUrls {
        ...
        nfe_consulta_protocolo: "https://nfe.svrs.rs.gov.br/ws/NfeConsulta/NfeConsulta4.asmx",
        nfe_inutilizacao: "https://nfe.svrs.rs.gov.br/ws/NfeInutilizacao/NfeInutilizacao4.asmx",
        nfe_status_servico:
...
pub mod tests {
    ...
    fn test_get_service_urls_homologation() {
        ...
        assert!(urls
            .nfe_autorizacao
            .contains("nfe-homologacao.svrs.rs.gov.br"));
    }
    ...
    fn test_get_service_url() {
        let url = get_service_url(
            ...
            ServiceType::NfeStatusServico,
        );
        assert!(url.contains("NfeStatusServico"));
    }
}
